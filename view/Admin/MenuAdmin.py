...
class MenuAdmin(tk.Frame):
    ...
    def _add_elements_(self):
        ...
        self.delete = tk.Button(self,text="Delete Ingredient" ,  width=20,command=self._del_)
    ...
    def _setElements_(self):
        ...
        self.delete.place(relx=0.35,y=430,relwidth=0.3)
        self.exit.place(relx=0.35, y=470,relwidth=0.3)
        self._lbl_admin.place(relx=0.35,y=10)

    def _edit_(self):
        self._editPage._reinitialize_lb_()
        self.controller.show_frame("AModify")
        self.win.geometry("800x500")
