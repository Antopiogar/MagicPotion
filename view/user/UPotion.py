...
class UPotion(tk.Frame):
    ...
    def _add_elements_(self):
        self._lbl_title=tk.Label(self._canvas,text="Potions",font=("Arial",16))
        self._lbl_name=tk.Label(self._canvas,text="Name", font=("Arial",15))
        self._txt_name=tk.Entry(self._canvas,textvariable=self._name_var,font=("Arial",15))
        self._lbl_fire=tk.Label(self._canvas,text="Fire -> ", font=("Arial",12))
        self._txt_fire=tk.Entry(self._canvas,text="Fire>",textvariable=self._fire_var,font=("Arial",12))
        self._lbl_air=tk.Label(self._canvas,text=" Air ->", font=("Arial",12))
        self._txt_air=tk.Entry(self._canvas,text=" Air ",textvariable=self._air_var,font=("Arial",12))
        self._lbl_water=tk.Label(self._canvas,text="Water->" ,font=("Arial",12))
        self._txt_water=tk.Entry(self._canvas,text="Water",textvariable=self._water_var,font=("Arial",12))
        self._lbl_earth=tk.Label(self._canvas,text="Earth ->" ,font=("Arial",12))
        ...
        self._lbl_empty= tk.Label(self._canvas,text="",height=5)
    ...
    def _setElements_(self):
        ...
        self._lbl_title.place(relx=0.15,y=0,relwidth=0.7,rely=0.1)
        self._lbl_name.place(relx=0.40,y=120,relwidth=0.2)
        self._txt_name.place(relx=0.25,y=150,relwidth=0.5)
        self._lbl_fire.place(x=100,y=220)
        self._txt_fire.place(x=180,y=220,width=100)
        self._lbl_air.place(x=500,y=220)
        self._txt_air.place(x=580,y=220,width=100)
        self._lbl_earth.place(x=100,y=290)
        self._txt_earth.place(x=180,y=290,width=100)
        self._lbl_water.place(x=500,y=290)
